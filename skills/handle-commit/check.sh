...
# Pipeline + gates are enforced BEFORE commit by the MCP tool.
...
echo "{\"supplementary_output\": \"[academic-git] create_commit recorded a formal issue-linked commit. Pipeline + gates were enforced by academic-git MCP.\"}"
exit 0

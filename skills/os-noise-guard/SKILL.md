---
name: os-noise-guard
description: Prevent macOS and Windows metadata files from polluting ScholarOS worktrees and blocking session cleanup.
---
...
Prevent macOS and Windows filesystem metadata from making ScholarOS worktrees
...
- Do not depend on `.scholaros.json`; plugin activation is system-level.

---
name: lint
description: Run the ScholarOS local data-science lint pass. Use when Adrian asks for local lint, Python lint, R lint, ruff, lintr, or a quick static check before pushing.
...
Commands live in the project `.scholaros.json` file:
...
1. Run the `scholaros` `lint` tool with `target: "all"`.

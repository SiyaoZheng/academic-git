...
| [jerhadf/linear-mcp-server](https://github.com/jerhadf/linear-mcp-server) | 344 | MIT | Linear MCP server tool definitions |
...
## MCP Server, Plugin, Research Constitution (TODO #5, #6, #8)
